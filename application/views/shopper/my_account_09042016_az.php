...
<?php
      ...
      ?>
		  ...
		  <div class="panel-title accordion-toggle clearfix" >
			...
			<tr>
					<td rowspan="2" class="gray-box" ><span data-toggle="collapse" data-parent="#accordion" href="#<?php echo 'list_'.$single->id; ?>" class="indicator plus collapsed"><a class="plus_minus"></a></span></td>
				<td colspan="4">
				<div class="top-heading"><?php echo the_excerpt($product_details->name,'0','50'); ?></div> 
		...
		<div id="<?php echo 'list_'.$single->id; ?>" class="panel-collapse collapse">
      ...
      ?>
            <div class="panel panel-default expired_deals finished_review">
		  ...
		  <div class="panel-title accordion-toggle clearfix" >
			...
			<tr>
				...
				<td colspan="4">
				<div class="top-heading"><?php echo the_excerpt($product_details->name,'0','50'); ?></div> 
						<a class="btn btn-org pull-right gray">Approved !</a>
				</td>
			</tr>
              </table> 
		  </div>
