...
class Article extends CI_Model {
    ...
    public function __construct() {
        ...
        // Assign Table
        $this->table = $this->db->dbprefix('pages');
        $this->table_contact_us = $this->db->dbprefix('contact_us');
    }

    public function add_contact_us(array $input) {
        if ($this->db->insert($this->table_contact_us, $input)) {
