<div id="dashboard">
    ...
    <div class="row-fluid">
        <div class="span12">
            <a class="btn green" href="<?php echo site_url('backend/dcs/add') ?>"> <i class="icon-edit"></i> Add New</a><br/><br/>
        </div>
    </div>
                ...
                if (!empty($content)) {
                    ...
                    foreach ($content as $p) {
                        ...
                        $tr .='<tr class="odd gradeX ind'. $i .'">
                                ...
                                <td><img src="' . base_url('uploads/'.$p->image_name) . '" height="100px" width="100px" /></td>
                                <td>
                                    <a  data-id="' . $p->pid . '" data-hash="' . get_hash($p->pid) . '" data-index="'. $i .'" href="javascript:void(0);" class="btn red deletePage"><i class="icon-trash"></i></a>
                                </td>
                            </tr>';
