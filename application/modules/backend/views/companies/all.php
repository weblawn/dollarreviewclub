            ...
            <tbody>
                ...
                if (!empty($companies)) {
                    ...
                    foreach ($companies as $user) {
                        ...
                        $indicator = "red";
                        $alertLabel = "You want disable {$user->cname} company for now.";
                        $labelIcon = "<i class='icon-unlock-alt'></i>";
                        
                        if ($user->isDel == 1) {
                            $alertLabel = "You want enable {$user->cname} company for now.";
                        ...
                        $tr .='<tr class="odd gradeX ind' . $i . '">
                                ...
                                <td>
                                    <a href="' . site_url('admin/companies/' . $user->id . '/' . get_hash($user->id)) . '" class="btn blue"><i class="icon-eye-open"></i></a>
                                    <a href="' . site_url('backend/companies/edit/' . $user->id . '?hash=' . get_hash($user->id)) . '" class="btn blue"><i class="icon-edit"></i></a>
    ...
    jQuery(document).ready(function($) {
        ...
        $(document).on("click", "#deleYes", function() {
            ...
            $.ajax({
                ...
                dataType: "json",
                data: inputArray,
                url: "<?php echo site_url("backend/companies/visibility") ?>",
                beforeSend: function() {
