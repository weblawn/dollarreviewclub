  ...
  <?php /*<link rel="stylesheet" href="<?php echo assets_url('backend/plugins/bootstrap-wysiwyg-new/css/froala_editor.css'); ?>">
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="hero-unit" style="background: #f7f7f7; padding: 15px; ">
                    ...
                    <?php /*<div id="editor"><?php echo $page->content ?></div>*/ ?>
                    <textarea name="editor" id="editor" rows="10" cols="80"><?php echo $page->content ?></textarea>
                </div>
            </div>
...
<!-- END PAGE CONTAINER-->
  ...
  <?php /*<script type="text/javascript" src="<?php echo assets_url('backend/plugins/bootstrap-wysiwyg-new/js/froala_editor.min.js'); ?>" ></script>
