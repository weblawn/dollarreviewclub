...
<div class="contentbox page">
  ...
  <div class="form-group" id="launch_verify">
    <label for=" " class="col-md-4 control-label">Amazon Product ASIN:</label>
    <div class="col-md-8">
		<div class="row">
		<div class="col-md-7">
        ...
        <input type="hidden" id="aws_url" name="aws_url" value="" />
		</div>
		</div>
  ...
  <div class="form-group other_part">
   ...
   <div class="form-group product_details_textarea other_part">
    ...
    <div class="col-md-8">
	<div class="launch-form-field">
      <textarea class="form-control " id="product_details" name="product_details" placeholder="" cols="10" rows="10"></textarea>
  ...
  <div class="clearfix"></div>
  <div class="form-group other_part">
    <label for=" " class="col-sm-4 control-label pt0">Discount Code Upload:<br>(.txt file)</label>
    <div class="col-sm-8">
	<div class="launch-form-field">
   ...
   <div class="form-group launch-time other_part">
	...
	<div class="launch-form-field control-label ">
			...
			<input type="text" name="product_end_time_until_count" id="product_end_time_until_count" class="form-control inline-field w92" placeholder="500">
...
<div class="form-group other_part">
	...
	<li class="clearfix">
			<div class="launch-form-field control-label">
							...
							<label for="product_code_access_condition_none"><span></span>None</label>
			</div>
	</li>
	...
	<li class="clearfix">
			<div class="launch-form-field control-label">
							...
							<label for="product_code_access_condition_custom"><span></span>Auto, only customers who have </label>
			</div>
			...
			<span> or more approved reviews can access the discount code.</span>
	...
	<li class="clearfix">
			<div class="launch-form-field control-label">
							...
							<label for="product_code_access_condition_manual"><span></span>Manually approved by seller</label>
			</div>
	</li>
	</ul>
	</div>
 ...
 <div class="form-group other_part">
	...
	<ul class="other_photos list-inline">
		<li> <img src="<?php echo new_assets_url('img/upload_photo.jpg') ?>" class="img-responsive other_photo" style=" height: 51px; width: 61px;"  id="product_other_pic_preview_0"><input type="hidden" name="product_other_pic_val_0" id="product_other_pic_val_0" value="0" />     </li>
		<li> <img src="<?php echo new_assets_url('img/upload_photo.jpg') ?>" class="img-responsive other_photo" style=" height: 51px; width: 61px;"  id="product_other_pic_preview_1"><input type="hidden" name="product_other_pic_val_1" id="product_other_pic_val_1" value="0" />     </li>
		<li> <img src="<?php echo new_assets_url('img/upload_photo.jpg') ?>" class="img-responsive other_photo" style=" height: 51px; width: 61px;"  id="product_other_pic_preview_2"><input type="hidden" name="product_other_pic_val_2" id="product_other_pic_val_2" value="0" />     </li>
		<li> <img src="<?php echo new_assets_url('img/upload_photo.jpg') ?>" class="img-responsive other_photo" style=" height: 51px; width: 61px;"  id="product_other_pic_preview_3"><input type="hidden" name="product_other_pic_val_3" id="product_other_pic_val_3" value="0" />     </li>
		<li> <img src="<?php echo new_assets_url('img/upload_photo.jpg') ?>" class="img-responsive other_photo" style=" height: 51px; width: 61px;"  id="product_other_pic_preview_4"><input type="hidden" name="product_other_pic_val_4" id="product_other_pic_val_4" value="0" />     </li>
		<li> <img src="<?php echo new_assets_url('img/upload_photo.jpg') ?>" class="img-responsive other_photo" style=" height: 51px; width: 61px;"  id="product_other_pic_preview_5"><input type="hidden" name="product_other_pic_val_5" id="product_other_pic_val_5" value="0" />     </li>
		<li> <img src="<?php echo new_assets_url('img/upload_photo.jpg') ?>" class="img-responsive other_photo" style=" height: 51px; width: 61px;"  id="product_other_pic_preview_6"><input type="hidden" name="product_other_pic_val_6" id="product_other_pic_val_6" value="0" />     </li>
		<li> <img src="<?php echo new_assets_url('img/upload_photo.jpg') ?>" class="img-responsive other_photo" style=" height: 51px; width: 61px;"  id="product_other_pic_preview_7"><input type="hidden" name="product_other_pic_val_7" id="product_other_pic_val_7" value="0" />     </li>
