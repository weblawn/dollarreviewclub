...
<div class="contentbox page">
	...
	<div class="container">
		<div class="content page-shadow page">
           ...
           {
            header('Location: '.site_url('companies/campaign/launch_new'));
           }
  ...
  <div class="form-group" id="launch_verify">
    ...
    <div class="col-md-8">
        ...
        <input type="hidden" id="aws_url" name="aws_url" value="<?php echo $get_product_details->aws_url; ?>" />
		</div>
		</div>
  ...
  <div class="form-group other_part">
   ...
   <div class="form-group product_details_textarea other_part">
    ...
    <div class="col-md-8">
	<div class="launch-form-field">
      <textarea class="form-control " id="product_details" name="product_details" placeholder="" cols="10" rows="10"><?php echo $get_product_details->description; ?></textarea>
...
<div class="form-group other_part">
 ...
 <div class="form-group other_part">
	...
	<li class="clearfix">
			<div class="launch-form-field control-label">
							<input type="radio" id="review_suggetion_none" name="review_suggetion_none" value="review_suggetion_none" class="radiogroup" <?php if($get_product_details->review_suggetion_type == 'review_suggetion_none'){echo 'checked="checked"';} ?> >
...
?>
    ...
    foreach(unserialize($get_product_details->other_img_url) as $single)
    {
        ...
        ?>
        <li> <img src="<?php echo $other_pic_base64; ?>" class="img-responsive other_photo" style=" height: 51px; width: 61px;"  id="<?php echo 'product_other_pic_preview_'.$count; ?>" onclick="remove_image_value(<?php echo $count; ?>)"><input type="hidden" name="<?php echo 'product_other_pic_val_'.$count; ?>" id="<?php echo 'product_other_pic_val_'.$count; ?>" value="<?php echo $other_pic_base64; ?>" />     </li>
        <?php
        $count++;
    }
    for($i = $count; $i<8; $i++)
    {
        ...
        $other_pic_base64 = 'data:image/' . $type . ';base64,' . base64_encode($data);
        ?>
        <li> <img src="<?php echo $other_pic_base64; ?>" class="img-responsive other_photo" style=" height: 51px; width: 61px;"  id="<?php echo 'product_other_pic_preview_'.$i; ?>" onclick="remove_image_value(<?php echo $i; ?>)"><input type="hidden" name="<?php echo 'product_other_pic_val_'.$i; ?>" id="<?php echo 'product_other_pic_val_'.$i; ?>" value="0" />     </li>
        <?php
    }
	...
	$(document).on("submit", "form#launch_form", function(e) {
       ...
       var _alert = $("#launch_form_Alert");
		...
		$.ajax({
            ...
            type:"POST",
			url 			:"<?php echo site_url('companies/campaign/launch_update'); ?>", 
			dataType		: 'json',
			data			: data,
            contentType: false,
            cache: false,
