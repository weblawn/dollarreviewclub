...
<div class="contentbox page">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-7">
      ...
      <?php /*<div class="existing_value">  <?php echo $user->fname; ?></div>*/ ?>
    </div>
  </div>
  ...
  <div class="form-group select_one">
	...
	<div class="selectoption">
					<select class="form-control cat_control" name ="fav_cat_main" id ="fav_cat_main" placeholder="Choose Category">
    ...
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-org">Done</button>
		...
		<div role="tabpanel" <?php echo $show_tabpanel_2; ?> id="my_product_review">
			...
			<p class="text-right b-btm"><a href="<?php echo site_url('companies/campaign/launch_new');?>" class="btn btn-org">+ Launch New Product</a></p>
      ...
      { 
	   ...
	   <div class="panel panel-default" id="<?php echo 'tab_list_'.$single->pid; ?>">
		  ...
		  <div class="panel-title accordion-toggle clearfix" >
			...
			<tr>
					<td rowspan="2" class="gray-box" ><span data-toggle="collapse"  href="#<?php echo 'tab_id_'.$single->pid; ?>" class="indicator plus  <?php echo $parent_class;?>"><a class="plus_minus"></a></span></td>
				<td colspan="4">
...
function start_product(id)
{
    ...
    var url = "<?php echo site_url('companies/campaign/launch_edit'); ?>/"+id;
