...
! function(a) {
    ...
    a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
        ...
        imageUploadURL: "../../../upload/do_upload",
        ...
        function e() {
            ...
            var d = ha.offset().left + ha.outerWidth() / 2,
                e = ha.offset().top + ha.outerHeight();
        ...
        function i() {
            ...
            if (ta)
                for (c = 0; c < ta.length; c++) e.indexOf(ta[c].getAttribute("src")) < 0 && b.events.trigger("image.removed", [a(ta[c])]);
            ta = d
        }
        ...
        function v(c, d, e, f, g) {
            ...
            h.onload = function() {
                ...
                if (f) {
                    ...
                    var l = "";
                    if ("undefined" != typeof e)
                        for (h in e) "link" != h && (l += " data-" + h + '="' + e[h] + '"');
        ...
        function G() {
            ...
            var d = ha.offset().left + ha.width() / 2,
                e = ha.offset().top + ha.height();
        ...
        function N(a) {
            ...
            if (ha || b.opts.toolbarInline) ha && (d = ha.offset().top + ha.outerHeight());
            else {
