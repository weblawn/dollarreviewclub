    ...
    a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
                        ...
                        for (d = 0; d < g.length; d++)
                            if (0 === d || g[d][e] != g[d - 1][e])
                                if (f = a(g[d][e]), parseInt(f.attr("colspan"), 10) > 1) {
                                    ...
                                    1 == k ? f.removeAttr("colspan") : f.attr("colspan", k), f.css("width", ((f.data("old-width") - T(e, g)) * j / i).toFixed(4) + "%"), f.removeData("old-width")
                                } else {
        ...
        function L(c) {
            if (b.$el.find(".fr-selected-cell").length > 0 && !c.shiftKey && (E(), b.$el.removeClass("fr-no-selection"), b.edit.on()), 1 == c.which) {
                ...
                if (d) {
                    ...
                    c.shiftKey && a(e + ".fr-selected-cell").length > 0 ? a(a(e + ".fr-selected-cell").closest("table")).is(a(d).closest("table")) ? J(aa, d) : F() : ((b.keys.ctrlKey(c) || c.shiftKey) && F(), aa = d, J(aa, aa))
                }
            }
        }
        ...
        function M(c) {
            if (1 == c.which) {
                ...
                if (ca) {
                    ca = !1, $.removeClass("fr-moving"), b.$el.removeClass("fr-no-selection"), b.edit.on(), $.find("div").css("opacity", 0), $.hide();
                    var f = parseFloat($.css("left")) + b.opts.tableResizerOffset;
                    b.opts.iframe && (f -= b.$iframe.offset().left), $.data("release-position", f), $.removeData("max-left"), $.removeData("max-right"), S(c)
                }
            }
        }
        ...
        function N(c) {
            if (_ === !0) {
                ...
                if (d.closest("table").is(b.$el.find(".fr-selected-cell").closest("table"))) {
                    if ("TD" == c.currentTarget.tagName && 0 === b.$el.find("th.fr-selected-cell").length) return void J(aa, c.currentTarget);
                    if ("TH" == c.currentTarget.tagName && 0 === b.$el.find("td.fr-selected-cell").length) return void J(aa, c.currentTarget)
                }
                F()
            }
        }
        ...
        function P() {
            $ = a('<div class="fr-table-resizer"><div></div></div>'), b.$wp.append($), $.on("mousedown", function() {
                ca = !0, $.addClass("fr-moving"), E(), F(), $.find("div").css("opacity", 1)
            }), b.events.on("destroy", function() {
                $.off("mousedown"), $.html("").removeData().remove()
            }, !0)
        }
                ...
                if (Math.abs(c.pageX - f) <= b.opts.tableResizerOffset || Math.abs(g - c.pageX) <= b.opts.tableResizerOffset) {
                    ...
                    if (c.pageX - f <= b.opts.tableResizerOffset)
                        if (j = f, n.col > 0 && m[n.row][n.col - 1]) {
                            ...
                            k = 1 == (parseInt(s.attr("colspan"), 10) || 1) ? s.offset().left - 1 + b.opts.tableResizingLimit : f - T(n.col - 1, m) + b.opts.tableResizingLimit, l = 1 == (parseInt(e.attr("colspan"), 10) || 1) ? f + e.outerWidth() - b.opts.tableResizingLimit : f + T(n.col, m) - b.opts.tableResizingLimit, h = n.col - 1, i = n.col
                        } else h = null, i = n.col, k = p.parent().offset().left + parseFloat(p.parent().css("padding-left")), l = p.offset().left - 1 + p.outerWidth() - m[0].length * b.opts.tableResizingLimit;
        ...
        function R() {
            if (ca) {
                var a = $.data("table");
                $.css("top", a.offset().top - b.window.pageYOffset)
            }
        }
        ...
        function X(c) {
            ...
            if (d == a.FroalaEditor.KEYCODE.TAB && 0 === b.opts.tabSpaces) {
                ...
                e && (c.preventDefault(), E(), b.popups.hide("table.edit"), c.shiftKey ? e.prev().length > 0 ? W(e.prev()) : e.closest("tr").length > 0 && e.closest("tr").prev().length > 0 ? W(e.closest("tr").prev().find("td:last")) : e.closest("tbody").length > 0 && e.closest("table").find("thead tr").length > 0 && W(e.closest("table").find("thead tr th:last")) : e.next().length > 0 ? W(e.next()) : e.closest("tr").length > 0 && e.closest("tr").next().length > 0 ? W(e.closest("tr").next().find("td:first")) : e.closest("thead").length > 0 && e.closest("table").find("tbody tr").length > 0 ? W(e.closest("table").find("tbody tr td:first")) : (e.addClass("fr-selected-cell"), q("below"), E(), W(e.closest("tr").next().find("td:first"))), b.selection.restore())
            }
        }
        ...
        function Y() {
            return b.$wp ? (b.helpers.isMobile() || (_ = !1, ca = !1, P(), b.$el.on("mousedown.table" + b.id, L), b.popups.onShow("image.edit", function() {
            ...
            }), b.$el.on("mouseenter.table" + b.id, "th, td", N), b.$window.on("mouseup.table" + b.id, M), b.$el.on("keydown.table" + b.id, O), b.$window.on("mousemove.table" + b.id, V), a(b.window).on("scroll.table" + b.id, R), b.events.on("contentChanged", function() {
                ...
                if (b.$el.find(".fr-selected-cell").length > 0) {
                    if (c.which == a.FroalaEditor.KEYCODE.ESC) return E(), c.preventDefault(), c.stopPropagation(), c.stopImmediatePropagation(), !1;
