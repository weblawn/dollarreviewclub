...
! function(a) {
    ...
    a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
        ...
        function r() {
            ...
            var d = '<div class="fr-file-progress-bar-layer fr-layer"><h3 class="fr-message">Uploading</h3><div class="fr-loader"><span class="fr-progress"></span></div><div class="fr-action-buttons"><button type="button" class="fr-command" data-cmd="fileDismissError" tabIndex="2">OK</button></div></div>',
                ...
                f = b.popups.create("file.insert", e);
        ...
        function t() {
            ...
            b.events.on("dragenter", c), b.events.on("dragover", c), b.events.on("drop", function(c) {
                ...
                if (e && e.files && e.files.length) {
                    var f = e.files[0];
                    if (f && f.type && (b.opts.fileAllowedTypes.indexOf(f.type) >= 0 || b.opts.fileAllowedTypes.indexOf("*") >= 0)) {
    ...
    }, a.FroalaEditor.DefineIcon("insertFile", {
        NAME: "file-o"
    }), a.FroalaEditor.RegisterCommand("insertFile", {
        title: "Upload File",
        undo: !1,
        focus: !0,
    ...
    }), a.FroalaEditor.DefineIcon("fileBack", {
        NAME: "arrow-left"
    }), a.FroalaEditor.RegisterCommand("fileBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
