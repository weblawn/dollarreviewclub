...
! function(a) {
    ...
    b.DEFAULTS = {
        initOnClick: !1
    }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.0.5", b.INSTANCES = [], b.ID = 0, b.prototype._init = function() {
        ...
        for (var b in a)
            if (!this[b] && (this[b] = new a[b](this), this[b]._init && (this[b]._init(), this.opts.initOnClick && "core" == b))) return !1
        ...
        var j, k, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",
            m = function() {
                ...
                return document.cookie = d + "=;expires=Sat, 01 Jan 2050 00:00:01 GMT;domain=" + b + ";", b
            }(),
            n = b(c);
        return {
            _init: i
