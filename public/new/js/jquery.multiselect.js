    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            optionsWrap.on( 'click', 'input[type="checkbox"]', function(){
                ...
                console.log(instance.options.maxSelect);
                ...
                if(instance.options.maxSelect && (selOpts.length+1)>instance.options.maxSelect && $( this ).is( ":checked" ))
                {  
        ...
        _updatePlaceholderText: function(){
            ...
            $( ".selected_items" ).html('');
            select.find('option:selected').each(function(){
                $( ".selected_items" ).append( "<span>"+$(this).text()+"</span>" );
                if(selected_val=='')
                {
